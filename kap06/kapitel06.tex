...
The biased construction of Chapter~5 provides a pointwise envelope for
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{kap06/figures/fig_chain_fixed.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.86\textwidth]{kap06/figures/fig_passive.pdf}
...
has a true-problem limit. The plots in Chapters~7--9 are diagnostics; they
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{kap06/figures/fig_sharpmin.pdf}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.84\textwidth]{kap06/figures/fig_empconv.pdf}
