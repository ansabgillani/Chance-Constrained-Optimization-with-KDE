...
Chapters~4--6 establish the scalar residual reformulation and its analytic
...
the regularity and convergence assumptions stated in Chapter~6; it is not a
...
Chapter~5 gives an expectation envelope for a fixed decision. The principal next
...
log-sum-exp approximation $s_\tau$ from Chapter~5. For a training sample
