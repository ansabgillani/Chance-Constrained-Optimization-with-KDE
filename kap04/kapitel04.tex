...
$\E[\hat{p}_h^{\,b}(x)] \leq \Prob(g(x,\xi) \leq 0)$ at every decision. For a fixed decision $x$ independent of the sample, this gives an expectation
...
form of Chapter~2, the surrogate violation estimate dominates the true
violation probability pointwise. The estimator may still err, but the construction ensures that its
...
on the dispatch problem where the truth is computable. The comparison follows the question posed at the end of Chapter~3: the unbiased reformulation is smooth and less conservative, while the
