...
form of Chapter~2, the per-sample surrogate dominates the empirical
...
Chapter~3: one smooth inequality whose row count is independent of $N$,
...
on a standalone lognormal scalar diagnostic where the truth is computable. The comparison follows the question posed at the end of Chapter~3: the unbiased reformulation is smooth and less conservative, while the
...
interaction of these layers, including how conservatism compounds across $h$ and $\tau$, remains unresolved; Chapter~8 reports a joint-event diagnostic rather than a risk-allocation study.
