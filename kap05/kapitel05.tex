...
operate under explicit regularity conditions, and \citet{schuster2025} makes
...
uniqueness and supplies the growth condition, so the hypothesis of
...
Taken together, the three theorems establish two properties used by this
thesis. First, the KDE approach is asymptotically consistent at the level of
the optimization problem, rather than only at the estimator level.
