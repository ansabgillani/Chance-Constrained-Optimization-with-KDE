...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.94\textwidth]{kap09/figures/fig_static_test_violation}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.88\textwidth]{kap09/figures/fig_static_tradeoff}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.94\textwidth]{kap09/figures/fig_paper_aligned_static}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.90\textwidth]{kap09/figures/fig_sensitivity}
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=0.94\textwidth]{kap09/figures/fig_paper_aligned_dispatch}
...
claim language are defined in Chapter~8; Chapter~10 interprets these observations.
